...
vddata = load ('eight_weeks_data_2_13_untreated.m'); % load concatenated data set (long Mx2 matrix
...
params0 = [.3; .3; .3; .3; .3; .3; .3; .3; .3; .3; .3; .3];
%  res2sq=ones([n 1]);
coeffs3 = load('beta3new.mat');
coeffs3 = struct2cell(coeffs3);
coeffs3 = cell2mat(coeffs3);
[beta3unt, resnorm3, residuals3] = lsqnonlin(@fit_simp3pop6weeks_untreated,...
    params0,...
    paramslb,...
    paramsub,...
    options,...

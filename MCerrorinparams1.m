function [ lowerlim, upperlim, errorbarlength, beta1sim ] = MCerrorinparams1( vddata, v_model1, beta1, kstd, wknum, Vmaxall)
...
beta1sim(:,i) = lsqnonlin(@fit_simp1popunw, initials1new,[0; 0],[ Inf; Inf],options,dose,datasetsim, wknum_MC, Vmaxall_MC);

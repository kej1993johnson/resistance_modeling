function difforignew = fit_simp3pop8weeks_untreated( beta3new, dose, var, wknum, Vmaxall,coeffs3 )
...
fvec1((sum(nsize(1:7))+1:sum(nsize(1:7)))) = f81;
...
fvec2((sum(nsize(1:7))+1:sum(nsize(1:7)))) = f82;

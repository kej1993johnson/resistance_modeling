...
vmodel1 = model1popallweeksnormed( dose, betaLD50, Vmaxbyweek, nsize);
...
errorbar(time, betaLD50(16:30), errorbarsLD50(16:30)./2, '-ro', 'LineWidth', 2)
hold on
errorbar(0, betaLD50naive(2), errorbarlength1bootnaive(2.)./2,'bo', 'LineWidth',2)
...
errorbar(time, betaLD50unt(16:30), errorbarlengthLD50untreated(16:30)./2,'bo-', 'LineWidth',2)
ylim ([20,80])

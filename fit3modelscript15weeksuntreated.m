...
[beta1unt, resnorm1, residuals1] = lsqnonlin(@fit_simp1popunw, initials1new,[0; 0],[ Inf; Inf],[],dose,var, wknum, Vmaxall);
X = (0:.1:250);
X = X'
v_model1=model1pop( dose, beta1unt, Vmaxweekavg );
v_model1plot = model1pop(X, beta1unt, Vmaxweekavg);
...
[lowerlim1boot, upperlim1boot] = BSerrorinparams1(residuals1, dose, beta1unt, Vmaxweekavg, vddata);
...
% outputs betaLD50 with first 12 paramters slope values, second 12 are
% center values in week order
[betaLD50unt, resnormLD50, residualsLD50] = lsqnonlin(@fit_simpLD5015,...
    params0,...
    paramslb,...
    paramsub,...
    options,...
...
[lowerlimLD50boot, upperlimLD50boot] = BSerrorinparamsLD50(residualsLD50, vddata, betaLD50unt);

%% Print Boot strapping limits
lowerlimLD50boot = lowerlimLD50boot
upperlimLD50boot = upperlimLD50boot
errorbarlengthLD50bootuntreated = upperlimLD50boot-lowerlimLD50boot
...
bulk_model_LD50 = model_bulk_LD50( dose, betaLD50unt, Vmaxall, wk );
...
%  res2sq=ones([n 1]);
[beta2unt, resnorm2, residuals2] = lsqnonlin(@fit_simp2popunw15_untreated,...
    params0,...
    paramslb,...
    paramsub,...
    options,...

function [k1,k2] = fitabsoluteresiduals14w( dose, var, wknum, Vmaxall)
...
[beta2newunw, resnorm2unw, residuals2unw] = lsqnonlin(@fit_simp2popunw18p,...
    params0,...
    paramslb,...
    paramsub,...
    options,...
...
dose_res = horzcat(dose,absresiduals1, absresiduals2);

% creates matrix with 3 rows of zeros to be filled by weights for the
% specific dose
data_w_weights = [dose_res zeros([ n 2])]; 
...
dose_resavg1 = horzcat(avgdose1, avgbin1res1, avgbin1res2);
...
if dose_res(j,1) < 0.0311
    data_w_weights(j,4) = w1_1;
    data_w_weights(j,5) = w1_2;
end
end
...
dose_resavg2 = horzcat(avgdose2, avgbin2res1, avgbin2res2);
...
if dose_res(j,1)> 0.0311 && dose_res(j,1) <= 1
    data_w_weights(j,4) = w2_1;
    data_w_weights(j,5) = w2_2;
end
end
...
dose_resavg3 = horzcat(avgdose3, avgbin3res1, avgbin3res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w3_1;
    data_w_weights(j,5) = w3_2;
    end
end
...
dose_resavg4 = horzcat(avgdose4, avgbin4res1, avgbin4res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w4_1;
    data_w_weights(j,5) = w4_2;
    end
end
...
dose_resavg5 = horzcat(avgdose5, avgbin5res1, avgbin5res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w5_1;
    data_w_weights(j,5) = w5_2;
    end
end
...
dose_resavg6 = horzcat(avgdose6, avgbin6res1, avgbin6res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w6_1;
    data_w_weights(j,5) = w6_2;
    end
end
...
dose_resavg7 = horzcat(avgdose7, avgbin7res1, avgbin7res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w7_1;
    data_w_weights(j,5) = w7_2;
    end
end
...
dose_resavg8 = horzcat(avgdose8, avgbin8res1, avgbin8res2);
w8_1 = 1./(avgbin8res1);
w8_2 = 1./(avgbin8res2);

for j = 1:n
    if dose_res(j,1) >=36 && dose_res(j,1) < 45
    data_w_weights(j,4) = w8_1;
    data_w_weights(j,5) = w8_2;
    end
end
...
dose_resavg9 = horzcat(avgdose9, avgbin9res1, avgbin9res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w9_1;
    data_w_weights(j,5) = w9_2;
    end
end
...
dose_resavg10 = horzcat(avgdose10, avgbin10res1, avgbin10res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w10_1;
    data_w_weights(j,5) = w10_2;
    end
end
...
dose_resavg11 = horzcat(avgdose11, avgbin11res1, avgbin11res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w11_1;
    data_w_weights(j,5) = w11_2;
    end
end
...
dose_resavg12 = horzcat(avgdose12, avgbin12res1, avgbin12res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w12_1;
    data_w_weights(j,5) = w12_2;
    end
end
% 13th bin 109-144
...
dose_resavg13 = horzcat(avgdose13, avgbin13res1, avgbin13res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w13_1;
    data_w_weights(j,5) = w13_2;
    end
end
...
dose_resavg14 = horzcat(avgdose14, avgbin14res1, avgbin14res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w14_1;
    data_w_weights(j,5) = w14_2;
    end
end
...
dose_resavg15 = horzcat(avgdose15, avgbin15res1, avgbin15res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w15_1;
    data_w_weights(j,5) = w15_2;
    end
end
...
dose_resavg16 = horzcat(avgdose16, avgbin16res1, avgbin16res2);
...
for j = 1:n
    ...
    data_w_weights(j,4) = w16_1;
    data_w_weights(j,5) = w16_2;
    end
end
...
weight_by_absres1 = data_w_weights(:,4);
weight_by_absres2 = data_w_weights(:,5);

...
[beta1onedose, resnorm1, residuals1] = lsqnonlin(@fit_simp1popunw, initials1new,[0; 0],[ Inf; Inf],[],dose,var, wknum, Vmaxall);
X = (0:.1:250);
X = X'
v_model1=model1pop( dose, beta1onedose, Vmaxweekavg );
v_model1plot = model1pop(X, beta1onedose, Vmaxweekavg);
...
[lowerlim1boot, upperlim1boot] = BSerrorinparams1(residuals1, dose, beta1onedose, Vmaxweekavg, vddata);
...
errorbarlength1onedose = upperlim1boot-lowerlim1boot
...
legend('Experimental Treated Viability','Treated Single Static Population Model LD50 = 46.75 uM', 'Untreated Single Static Population Model. LD50 = 38.18 uM')
...
% outputs betaLD50 with first 12 paramters slope values, second 12 are
% center values in week order
[betaLD50onedose, resnormLD50, residualsLD50] = lsqnonlin(@fit_simpLD5015,...
    params0,...
    paramslb,...
    paramsub,...
    options,...
...
vmodel1 = model1popallweeksnormed( dose, betaLD50onedose, Vmaxbyweek, nsize);
...
[lowerlimLD50boot, upperlimLD50boot] = BSerrorinparamsLD50(residualsLD50, vddata, betaLD50onedose);

%% Print Boot strapping limits
lowerlimLD50boot = lowerlimLD50boot
upperlimLD50boot = upperlimLD50boot
errorbarlengthLD50onedose = upperlimLD50boot-lowerlimLD50boot
...
time = 0:1:15;
betaLD50 = vertcat(betaLD50naive(2), betaLD50(16:30));
errorbarsLD50 = vertcat(errorbarlength1bootnaive(2), errorbarsLD50(16:30));
...
errobarsLD50onedose = vertcat(errorbarlength1bootnaive(2), errorbarlengthLD50onedose(16:30)');
...
errorbar(time, betaLD50, errorbarsLD50./2, '-ro', 'LineWidth', 2)
hold on
errorbar(time, betaLD50onedose, errorbarsLD50onedose./2, '-go', 'LineWidth',2)
xlabel ('Time Post Treatment', 'FontSize', 16)
ylabel ('Single Population LD50', 'FontSize', 16)
set(gca,'LineWidth',1.5,'FontSize',16)
errorbar(time, betaLD50unt, errorbarsLD50untreated./2,'bo-', 'LineWidth',2)
ylim ([20,80])
title('Single Dynamic Population Model Removed Cohort 3 and 8','FontSize', 18)
legend('Treated Single Population Response', 'Untreated Control at t=0', 'Naive Response')
...
% Plot of LD50s over time
%plot(time, betaLD50(16:30), 'o', 'LineWidth', 4)
errorbar(time, betaLD50(16:30), errorbarsLD50(16:30), 'b-', 'LineWidth', 2)
hold on
...
%  res2sq=ones([n 1]);
[beta2onedose, resnorm2, residuals2] = lsqnonlin(@fit_simp2popunw15_untreated,...
    params0,...
    paramslb,...
    paramsub,...
    options,...
...
v_model2allweeksnormed = model2popallweeksnormed( dose, beta2onedose, Vmaxbyweek, nsize);
...
beta2_comb = vertcat(coeffs2, beta2onedose);
[lowerlim2boot, upperlim2boot] = BSerrorinparams2(residuals2, beta2_comb, vddata);
errorbarlength2onedose = upperlim2boot-lowerlim2boot;
%%
